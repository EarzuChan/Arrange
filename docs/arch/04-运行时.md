...
[调度线程与帧阶段](26-调度线程与帧阶段.md)；[LayoutTree与NativeTransaction](15-LayoutTree与NativeTransaction.md)；[SFA 与模板写法](33-SFA与模板写法.md)；[互操作](16-互操作.md)；[事件系统](17-事件与输入.md)；[ADR 009](../adr/009-ArrangeVue阶段化响应式与ReactiveSlotRuntime.md)。
