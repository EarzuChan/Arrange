...
export type TemplateChildNode = | ElementNode | InterpolationNode | CompoundExpressionNode | TextNode | CommentNode
...
export type ElementNode = | PlainElementNode | ArrangableNode | SlotOutletNode | TemplateNode
