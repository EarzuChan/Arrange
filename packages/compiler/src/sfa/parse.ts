...
import { type BindingMetadata, type CompilerError, type ElementNode, NodeTypes, type ParserOptions, type RawSourceMap, type RootNode, type SourceLocation, createRoot } from '../core/index.ts'
import { genCacheKey } from '@arrange/shared'
