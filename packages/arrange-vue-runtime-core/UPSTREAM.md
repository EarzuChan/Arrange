...
基线：vuejs/core 3.5.34，原始目录 `packages/runtime-core`。本包是 Arrange 定制分支，不再与上游逐文件同步。

本包负责Arrangable、结构协调、值绑定、调度和作用域生命周期。生产语义以 [Arrange Vue 宿主目标](../../docs/arch/27-ArrangeVue宿主目标.md) 为准。
