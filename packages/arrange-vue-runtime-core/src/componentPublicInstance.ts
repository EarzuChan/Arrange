...
import { type Attrs, type ComponentInternalInstance, type Data, getComponentPublicInstance, isStatefulComponent } from './component.ts'
...
export type ComponentPublicInstanceConstructor<T extends ComponentPublicInstance<any> = ComponentPublicInstance<any>> = {
    __isFragment?: never
    __isTeleport?: never
    __isSuspense?: never
    new (...args: any[]): T
...
export type ComponentPublicInstance<P = {}, B = {}, E extends EmitsOptions = {}, PublicProps = {}, Defaults = {}, MakeDefaultsOptional extends boolean = false, S extends SlotsType = {}, TypeRefs extends Data = {}, TypeEl extends RendererElement = any> = {
    ...
    $emit: EmitFn<E>
    $el: TypeEl
    $options: ComponentOptions<P, B, E, S>
    $forceUpdate: () => void
    $nextTick: typeof nextTick
    $watch<T extends string | ((...args: any) => any)>(source: T, cb: T extends (...args: any) => infer R ? (...args: [R, R, OnCleanup]) => any : (...args: [any, any, OnCleanup]) => any, options?: WatchOptions): WatchStopHandle
} & IfAny<P, P, Readonly<Defaults> & Omit<P, keyof ShallowUnwrapRef<B> | keyof Defaults>> & ShallowUnwrapRef<B> & ComponentCustomProperties
...
export const PublicInstanceProxyHandlers: ProxyHandler<any> = {
    ...
    set(
        ...
        if (hasSetupBinding(setupState, key)) {
            ...
            warn(`不能通过组件公开实例修改 <script setup> 绑定 "${key}"`)
            return false
