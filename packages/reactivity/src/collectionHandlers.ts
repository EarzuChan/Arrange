import { capitalize, extend, hasChanged, hasOwn, isMap, toRawType } from '@arrange/shared'
...
import { type Target, isReadonly, isShallow, toRaw, toReactive, toReadonly } from './reactive.ts'
