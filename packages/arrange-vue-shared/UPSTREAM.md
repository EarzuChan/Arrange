...
基线：vuejs/core 3.5.34，原始目录 `packages/shared`。本包源码已针对 Arrange 改造，不再与上游逐文件同步。

本包负责Arrange Vue 共用工具、宿主输入 schema 和编译标记。生产语义以 [Arrange Vue 宿主目标](../../docs/arch/27-ArrangeVue宿主目标.md) 为准。
