import { isObject, isString } from '@arrange/vue-shared'
...
export const isMemberExpression: (
    exp: ExpressionNode,
    context: TransformContext,
) => boolean = (isMemberExpressionNode)
...
const propsHelperSet = new Set([GUARD_REACTIVE_PROPS])
