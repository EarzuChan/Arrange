...
export type AnimationSpec =
    | Readonly<{kind: "tween"; durationMillis: number; delayMillis: number; easing: Easing}>
    | Readonly<{kind: "spring"; stiffness: number; dampingRatio: number; visibilityThreshold: number}>
    | Readonly<{kind: "snap"; delayMillis: number}>
