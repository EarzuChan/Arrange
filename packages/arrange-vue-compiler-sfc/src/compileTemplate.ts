...
import { type CodegenResult, type CompilerError, type CompilerOptions, type ElementNode, NodeTypes, type ParserOptions, type RawSourceMap, type RootNode, createRoot } from '@arrange/vue-compiler-core'
