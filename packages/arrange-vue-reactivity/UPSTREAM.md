...
基线：vuejs/core 3.5.34，原始目录 `packages/reactivity`。本包源码已针对 Arrange 魔改，不再与上游逐文件同步。

本包负责Ref、reactive、computed、watch 与依赖追踪。生产语义以 [Arrange Vue 宿主目标](../../docs/arch/27-ArrangeVue宿主目标.md) 为准。
