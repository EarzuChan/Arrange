...
<script setup>
import { AnimatedVisibility, Crossfade, Arrangement, m, ref, computed, tween, spring, linearEasing, animatedColorAsRef, animatedOffsetAsRef, animatedSizeAsRef, createTransition, getArrangeExecutionStats, animationStats, modifierStats, modifierAllocationStats, watch } from '@arrange/framework'
