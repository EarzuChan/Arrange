...
import {BRIDGE_MAGIC, BRIDGE_VERSION, encodeBridgeBatch, decodeBridgeBatch} from "../../packages/runtime/src/index.ts"
import type {BridgeOp} from "../../packages/runtime/src/index.ts"
